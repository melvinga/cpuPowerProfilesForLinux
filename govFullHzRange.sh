...
#     twice as max frequency set for them in powersave made.
#     The rest of the logical cores will have max frequency set to the minimum
#     possible processor frequency.
#
# Tested with:
#   - Intel i5 8265U:
#       (1) Ubuntu 18.04.4 LTS, MAX_FREQ_MULTIPLIER=8 (Dated: 29 Nov 2020)
#       (2) Ubuntu 20.04.1 LTS, MAX_FREQ_MULTIPLIER=8 (Dated: 05 Mar 2021)
#   - Intel i3 1315U:
#       (1) Ubuntu 22.04.5 LTS, MAX_FREQ_MULTIPLIER=5 (Dated: 18 Oct 2024)
#
